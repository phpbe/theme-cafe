...
namespace Be\Theme\Cafe\Section\AppCmsArticleDetail;
        ...
        if ($this->config->enable) {
            ...
            <div class="be-row be-mt-200">
                <div class="be-col-auto">
                    <div class="be-c-main be-bc-eee be-py-25 be-pl-50">
                ...
                <div class="be-col-auto">
                    <div class="be-bc-eee be-py-25 be-px-50">
                        <?php echo date('Y-m-d H:i', strtotime($this->page->article->publish_time)); ?>
                    </div>
                </div>
                ...
                <div class="be-col-auto">
                    <div class="be-bc-eee be-py-25 be-px-50">
                        <?php echo $this->page->article->hits; ?>
                    </div>
                </div>
            </div>


            <div class="be-mt-200 be-bt-eee be-pt-200">
